...
public class GenUtils {
     ...
     * html空间路径
     */
    private static  String TEMPLATES_PATH = "main/resources/templates";
    ...
    public static VelocityContext getVelocityContext(TableInfo table) {
        ...
        String packageName = GenConfig.PACKAGE_NAME;
        ...
        velocityContext.put("author", GenConfig.AUTHOR);
    ...
    public static String tableToJava(String tableName) {
        String autoRemovePre = GenConfig.AUTO_REMOVE_PRE;
        String tablePrefix = GenConfig.TABLE_PREFIX;
